...
-    Select “Download R 3.4.1 for Windows”
-    Open the downloaded file (R-3.4.1-win.exe)
...
-    Scrolld down and select “RStudio 1.0.153 - Windows Vista/7/8/10”
-    Open the downloaded file (RStudio-1.0.153)
-    Select “Run” if prompted
-    Follow the set-up instructions (if unsure of something, leave the default settings)
