...
The Github site ([https://github.com/berkeley-scf/r-bootcamp-2017](https://github.com/berkeley-scf/r-bootcamp-2017)) is updated more frequently (sometimes in real time) and is the master repository for materials for the modules; you can also get the individual files from Github. Instructions for accessing the materials on Github are on the Piazza site.
