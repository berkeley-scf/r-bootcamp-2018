...
The Piazza site ([https://piazza.com/berkeley/summer2017/rbootcamp2017/home](https://piazza.com/berkeley/summer2017/rbootcamp2017/home)) is the main site for the bootcamp. It has information on logistics, software installation, and the Q&A area for online questions.  

The Github site ([https://github.com/berkeley-scf/r-bootcamp-2017](https://github.com/berkeley-scf/r-bootcamp-2017)) is the master repository for materials for the modules; you can also get the individual files from Github. Instructions for accessing the materials on Github are on the Piazza site.
...
Counselors will be available to help answer any questions you have (just wave to one of them), or feel free to just ask the presenter during the presentation. The counselors will also be monitoring the [Piazza Q&A area](https://piazza.com/berkeley/summer2017/rbootcamp2017/home), so feel free to type in a question there and one of the counselors will answer the question. Or if you know the answer, help us out by answering it yourself or adding your thoughts. 

Your counseloRs are: Kellie Ottoboni (Statistics/BIDS), Nima Hejazi (Biostatistics), Kalyan Katuri (LBL), Evan Muzzall (D-Lab), and Sara Stoudt (Statistics).
...
- `git clone https://github.com/berkeley-scf/r-bootcamp-2017`

Then to update from the repository to get any changes we've made:

- `cd /directory/where/you/put/the/repository/r-bootcamp-2017`
- `git pull`

## As a zip file

If you don't want to bother using Git or have problems, simply download a zip file with all the material from [https://github.com/berkeley-scf/r-bootcamp-2017/archive/master.zip](https://github.com/berkeley-scf/r-bootcamp-2017/archive/master.zip).
